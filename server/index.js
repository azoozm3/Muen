...
app.use(
  "/api/auth/signin",
  apiRateLimit({ windowMs: 60_000, max: 12, keyPrefix: "signin" }),
);
app.use(
  "/api/auth/signup",
  apiRateLimit({ windowMs: 60_000, max: 10, keyPrefix: "signup" }),
);
app.use(
  "/api/requests",
  apiRateLimit({ windowMs: 60_000, max: 40, keyPrefix: "requests" }),
);
